...
export function AiOverlay() {
  ...
  const startPipeline = useAiStore((s) => s.startPipeline);
  ...
  const handleStart = () => {
    ...
    startPipeline(unprocessed.map((p) => p.id));
          ...
          <View style={styles.actions}>
            ...
            >
              <Text
                style={[
                  styles.btnText,
                  { color: status.isRunning ? theme.colors.outline : theme.colors.onPrimary },
                ]}
              >
                {status.isRunning ? '分析中...' : '开始分析'}
              </Text>
            </Pressable>
          </View>
        </View>
